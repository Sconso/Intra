...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/assetic/config'), false)));
    ...
    {
        require_once '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/jms_diextra/doctrine/EntityManager_536146ef1c530.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_9c271e49090713de2e128d86814d45ba');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_9c271e49090713de2e128d86814d45ba');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_9c271e49090713de2e128d86814d45ba');
        ...
        $f->setProxyDir('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager536146ef1c530_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/logs/prod.log', 100, true);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/sessions');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/translations', 'debug' => false));
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod',
            ...
            'session.save_path' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/sessions',
            ...
            'router.resource' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/jms_diextra/doctrine/EntityManager_536146ef1c530.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager536146ef1c530_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/prod/jms_security',
