...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/dev/annotations', true);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'sc_symfony', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'Demo', 'password' => 'demo', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
     ...
     *
     * @return Application\Sonata\UserBundle\Admin\Entity\UserAdmin A Application\Sonata\UserBundle\Admin\Entity\UserAdmin instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return Sonata\AdminBundle\Form\Type\StatusType A Sonata\AdminBundle\Form\Type\StatusType instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return Application\Sonata\UserBundle\Form\Type\ProfileType A Application\Sonata\UserBundle\Form\Type\ProfileType instance.
     */
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/dev/translations', 'debug' => true));
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/../web', true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/dev/jms_security', true));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'debug.container.dump' => '/Volumes/Data/nfs/zfs-student-4/users/2013/sconso/mamp/apps/symfony/htdocs/app/cache/dev/appDevDebugProjectContainer.xml',
